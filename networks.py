...
#         print('wide_resnet_t %d-%d-%d' %(depth, k, in_planes))
        ...
        self.layer1 = self._wide_layer(
            self.wide_basic, nStages[1], n, dropout_rate, stride=1, bn=bn)
        self.layer2 = self._wide_layer(
            self.wide_basic, nStages[2], n, dropout_rate, stride=2, bn=bn)
        self.layer3 = self._wide_layer(
            self.wide_basic, nStages[3], n, dropout_rate, stride=2, bn=bn)
        self.bn1 = nn.BatchNorm2d(
    ...
    def add_activation_hooks(self):
        ...
        hooks = hooks = [
            partial(save_activation, name=f'layer{i}') for i in range(1, 5)]
